...
//---- No incluir funext.c cuando MySQL NO este instalado en el sistema
...
/*
* La libreria 'funnaks_nomy.c' es para usar cuando no esta instalado MySQL.
* En ese caso, debe comentarse tambien, el envio de la transaccion a trxfinan,  
*/
#include "/usr/lib/comunes/funnaks_nomy.c"
   ...
   if (resuresp!=-1){
      switch (msg->tipotrx) {
	  	...
	  	case TRX_PRUEBA:
		          ...
		          //------- Comentar cuando MySQL NO esta instalado en el sistema, desde AQUI 
			  /*
		           pid1 = fork();
			   if (pid1==-1) {
			      toLog("Fork Error!\n","fork",1,1);
